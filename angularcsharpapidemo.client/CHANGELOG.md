...
- Create Angular project with ng: `ng new angularcsharpapidemo.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularcsharpapidemo.client.esproj`).
